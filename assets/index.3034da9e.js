...
`,R=t.div``;var V="/amazonclonazepam/assets/screen.ed436401.png";const l=({img:e,sub:r,p:d})=>a(E,{children:[i(H,{src:e}),i(A,{children:r}),i(j,{children:d})]}),E=t.div`
display:flex;
flex-direction:column;
width:30%;
align-items:center;
...
`;function ee(){return i("div",{children:i(f,{basename:"/amazonclonazepam",children:i(b,{children:i(w,{path:"/",element:i(Y,{})})})})})}var ie={mediaQueries:{mediaPc:"only screen and (min-width:1025px)",mediaTablet:"only screen and (max-width: 1024px) and (min-width:617px)",mediaCel:"only screen and (max-width:616px)"}};x.render(i(y,{theme:ie,children:i(ee,{})}),document.getElementById("root"));
