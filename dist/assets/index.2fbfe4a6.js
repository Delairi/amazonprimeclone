import{s as t,j as p,L as m,B as f,R as b,a as w,b as x,c as y,F as k}from"./vendor.a2a4466b.js";const v=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))g(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&g(s)}).observe(document,{childList:!0,subtree:!0});function d(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerpolicy&&(r.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?r.credentials="include":n.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function g(n){if(n.ep)return;n.ep=!0;const r=d(n);fetch(n.href,r)}};v();const A=t.h1`
color:white;
font-size:2.5em;
...
`,i=p.exports.jsx,a=p.exports.jsxs,z=()=>a(K,{children:[i(I,{}),a(L,{children:[i(A,{children:"Welcome to prime video"}),i(V,{children:a(c,{children:["Enjoy exclusive Amazon Originals as well as popular movies and TV shows for ",i("strong",{children:"PEN 16.99"})," /month. Watch now, cancel anytime."]})}),i(m,{to:"/hola",children:"Prime Video Member? Sign in"}),a(U,{children:[i(h,{}),i(R,{children:"or"}),i(h,{})]}),i(m,{to:"/hola",children:"Start your free trial*"}),i(T,{children:"*Cancel your trial at any time"})]})]}),L=t.div`
display:flex;
...
`,V=t.div``;var E="/amazonclonazepam/assets/screen.ed436401.png";const l=({img:e,sub:o,p:d})=>a(j,{children:[i(P,{src:e}),i(C,{children:o}),i(H,{children:d})]}),j=t.div`
display:flex;
flex-direction:column;
width:30%;
align-items:center;
...
`,N=()=>a(S,{children:[i(J,{}),i(O,{children:a(W,{children:[i(M,{}),i(u,{children:"EN"}),i(u,{children:"Sign In"})]})})]}),S=t.div`
display:flex;
flex-direction:row;
padding:1em;
justify-content:center;
...
`,_=()=>a("div",{children:[i(N,{}),i(z,{}),a(ee,{children:[i(l,{img:E,sub:"Watch anywhere",p:"Enjoy from the web or with the Prime Video app on your phone, tablet, or select Smart TVs \u2014 on up to 3 devices at once."}),i(l,{img:Z,sub:"Download and go",p:"Watch offline on the Prime Video app when you download titles to your iPhone, iPad, Tablet, or Android device."}),i(l,{img:F,sub:"Data saver",p:"Control data usage while downloading and watching videos on select phones or tablets."})]}),i(D,{})]}),ee=t.div`
display:flex;
flex-direction:row;
...
`;function ie(){return i("div",{children:i(f,{children:i(b,{children:i(w,{path:"/",element:i(_,{})})})})})}var te={mediaQueries:{mediaPc:"only screen and (min-width:1025px)",mediaTablet:"only screen and (max-width: 1024px) and (min-width:617px)",mediaCel:"only screen and (max-width:616px)"}};x.render(i(y.StrictMode,{children:i(k,{theme:te,children:i(ie,{})})}),document.getElementById("root"));
